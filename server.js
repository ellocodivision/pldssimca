...
function normalizeHojaReservaSimcaLayout(input) {
  ...
  const out = {
    ...
    page1Scale: clampNumber(src.page1Scale, 0.84, 0.7, 1.15),
    ...
    page2Scale: clampNumber(src.page2Scale, 0.86, 0.7, 1.15),
    ...
    signatureOffsetY: clampNumber(src.signatureOffsetY, -42, -180, 180),
    ...
    docsOffsetY: clampNumber(src.docsOffsetY, -44, -180, 180),
    page1LabelSize: clampNumber(src.page1LabelSize, 16, 12, 28),
    page1ValueSize: clampNumber(src.page1ValueSize, 14, 10, 24),
    page2LabelSize: clampNumber(src.page2LabelSize, 16, 12, 28),
    page2ValueSize: clampNumber(src.page2ValueSize, 14, 10, 24),
    tableHeaderSize: clampNumber(src.tableHeaderSize, 13, 10, 22),
    tableBodySize: clampNumber(src.tableBodySize, 13, 10, 22),
    signatureTitleSize: clampNumber(src.signatureTitleSize, 18, 12, 28),
    signatureNoteSize: clampNumber(src.signatureNoteSize, 11, 8, 18),
    docsTitleSize: clampNumber(src.docsTitleSize, 13, 10, 22),
    docsTextSize: clampNumber(src.docsTextSize, 13, 10, 22),
