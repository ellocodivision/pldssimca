...
const VICEROY_RESERVATION_STATIC_LAYOUT = {
  page1: {
    ...
    paymentLabelRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 327, 170, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 343, 170, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 359, 170, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 375, 170, 14)
    ],
    paymentPercentRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 324, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 340, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 356, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 372, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 388, 28, 14)
    ],
    paymentAmountRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 324, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 340, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 356, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 372, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 388, 92, 14)
    ],
    paymentDateRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 324, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 340, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 356, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 372, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 388, 134, 14)
    ],
    amountCurrency: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 52, 419, 260, 18),
    cardNumber: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 329, 419, 260, 18),
    cardName: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 52, 449, 260, 18),
    cardType: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 329, 449, 260, 18),
    cardAddress: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 52, 481, 260, 18),
    cardCityStateZip: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 52, 513, 540, 18),
    expirationDate: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 52, 545, 260, 18),
    securityCode: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 329, 545, 260, 18),
    signature: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 210, 620, 200, 18)
  },
  page2: {
