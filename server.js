...
function normalizeHojaReservaSimcaLayout(input) {
  ...
  const out = {
    ...
    page1Scale: clampNumber(src.page1Scale, 0.92, 0.7, 1.15),
    page1OffsetX: clampNumber(src.page1OffsetX, 0, -240, 240),
    page1OffsetY: clampNumber(src.page1OffsetY, -10, -320, 320),
    page2Scale: clampNumber(src.page2Scale, 0.94, 0.7, 1.15),
    page2OffsetX: clampNumber(src.page2OffsetX, 0, -240, 240),
    page2OffsetY: clampNumber(src.page2OffsetY, -10, -320, 320),
    ...
    page1LabelSize: clampNumber(src.page1LabelSize, 18, 12, 28),
    page1ValueSize: clampNumber(src.page1ValueSize, 16, 10, 24),
    page2LabelSize: clampNumber(src.page2LabelSize, 18, 12, 28),
    page2ValueSize: clampNumber(src.page2ValueSize, 16, 10, 24),
    tableHeaderSize: clampNumber(src.tableHeaderSize, 14, 10, 22),
    tableBodySize: clampNumber(src.tableBodySize, 15, 10, 22),
    signatureTitleSize: clampNumber(src.signatureTitleSize, 20, 12, 28),
    signatureNoteSize: clampNumber(src.signatureNoteSize, 12, 8, 18),
    docsTitleSize: clampNumber(src.docsTitleSize, 14, 10, 22),
    docsTextSize: clampNumber(src.docsTextSize, 14, 10, 22),
