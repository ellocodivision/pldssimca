...
const VICEROY_RESERVATION_STATIC_LAYOUT = {
  page1: {
    ...
    paymentLabelRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 331, 170, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 347, 170, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 363, 170, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 99, 379, 170, 14)
    ],
    paymentPercentRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 327, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 343, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 359, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 375, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 391, 28, 14)
    ],
    paymentAmountRows: [
    ...
    paymentDateRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 327, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 343, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 359, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 375, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 391, 134, 14)
    ],
