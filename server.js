...
const VICEROY_RESERVATION_STATIC_LAYOUT = {
  page1: {
    ...
    paymentPercentRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 328, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 344, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 360, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 376, 28, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 248, 392, 28, 14)
    ],
    paymentAmountRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 328, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 344, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 360, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 376, 92, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 300, 392, 92, 14)
    ],
    paymentDateRows: [
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 328, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 344, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 360, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 376, 134, 14),
      rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 452, 392, 134, 14)
    ],
    ...
    signature: rectFromTop(VICEROY_RESERVATION_PAGE_HEIGHT, 210, 628, 200, 18)
  },
  page2: {
